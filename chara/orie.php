...
<html lang="en">
  ...
  <body>
    ...
    <img src="../img/chara_portrait/orie_portrait.png" alt="Orie" class="chara-portrait" />
    ...
    <table class="table-striped table-bordered table-hover frame-data-table">
      ...
      <tbody>
        ...
        <tr>
          <td>5C</td>
          <td class="balance-change">11</td>
          <td>-9</td>
          <td>high</td>
          <td>PCSE</td>
          <td class="balance-change">37</td>
          <td>580</td>
          <td>-</td>
          <td class="balance-change">
            change: startup: 12F → 11F <br>
            total frames: 38 → 37
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>-</td>
          <td class="balance-change">
            change: startup: 9F → 8F <br>
            block advantage: -8F → -5F <br>
            total frames: 28 → 24
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>30</td>
          <td>720</td>
          <td class="balance-change">8~19 leg</td>
          <td><!-- Fill this out --></td>
        </tr>
        <!-- TODO: JA for Orie -->
        <tr>
